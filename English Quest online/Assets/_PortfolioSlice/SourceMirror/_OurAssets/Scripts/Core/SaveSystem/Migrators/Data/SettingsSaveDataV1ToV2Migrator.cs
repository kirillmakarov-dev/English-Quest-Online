...
{
    /// <summary>
    /// Migrates <see cref="Data.SettingsSaveData"/> from schema version 1 to version 2.
    /// Fill in the <see cref="Migrate"/> body when schema changes are made.
    /// </summary>
    public sealed class SettingsSaveDataV1ToV2Migrator : ISaveMigrator
    {
        /// <inheritdoc/>
        public Type DomainType => typeof(SettingsSaveData);

        /// <inheritdoc/>
        public int FromVersion => 1;

        /// <summary>
        /// Transforms a v1 <see cref="Data.SettingsSaveData"/> JSON object to the v2 shape.
